...
from .views import AboutView, CourseListView, ManageCourseListView, \
    CreateCourseView, DeleteCourseView, CreateLessonView, ListLessonsView, \
    DetailLessonView, StudentListLessonView
...
urlpatterns = [
    ...
    path('course-manage/', ManageCourseListView.as_view(), name="manage_course"),
