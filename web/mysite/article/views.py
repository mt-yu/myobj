...
from django.core.paginator import Paginator, EmptyPage, PageNotAnInteger    # 实现分页的django 内置模块
import json
...
# 加入装饰器 csrf_exempt 解决提交表单中的CSRF 问题
@csrf_exempt
...
@login_required(login_url='/account/login')
@require_POST   # 该装饰器保证视图函数只接收通过POST方式提交的数据
@csrf_exempt
...
def article_list(request):
    ...
    try:
        ...
        current_page = paginator.page(paginator.num_pages)  # paginator.num_pages返回页数
        articles = current_page.object_list
